...
urlpatterns = [
    ...
    path('pacientes/', EspecialidadesListCreateView.as_view(), name='pacientes-list-create'),
    path('pacientes/<int:pk>/', EspecialidadesRetrieveUpdateDestroyView.as_view(), name='pacientes-retrieve-update-destroy'),
